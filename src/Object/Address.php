...
class Address implements JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        ...
        if (empty($vars array('complement'))) {
            unset($vars array('complement'));
        }
    ...
    public function getRegion()
    {
        if ($this->country == 'BRA'){
            ...
            if (isset($brStatesNames array($regionCode))){
                return $brStatesNames array($regionCode);
            }
        }
