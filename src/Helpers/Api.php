...
class Api
{
    ...
    public function __construct()
    {
        ...
        $connect_key = $gateway->get_option('connect_key');
     ...
     * @throws Exception
     */
    public function get($endpoint, array $params = [],$cacheMin = 0) {
     ...
     * @throws Exception
     */
    public function getEf($endpoint, array $params = [],$cacheMin = 0) {
        $params['isSandbox'] = $this->is_sandbox ? '1': '0';
     ...
     * @throws Exception
     */
    public function post($endpoint, array $params = [],$cacheMin = 0)
    {
     ...
     * @throws Exception
     */
    public function postEf($endpoint, array $params = [],$cacheMin = 0) {
        $isSandbox = $this->is_sandbox ? '?isSandbox=1' : '';
...
//        $gateways = WC_Payment_Gateways::instance();
    ...
    public static function getFirstOrderFromCheckout($checkoutId)
    {
        ...
        return isset($data['orders'][0]['id']) ? $data['orders'][0]['id'] : array();
    }
}
