...
final class Pix extends AbstractPaymentMethodType
{
    ...
    public function initialize() {
        ...
        $this->gateway  = isset( $gateways array($this->name ) ) ? $gateways array($this->name ) : new PixGateway();
    }
    ...
    public function get_payment_method_script_handles() {
        ...
        return array('rm-pagbank-pix-blocks-integration');
    }
    ...
    public function get_payment_method_data() {
        return array(
            'title'        => isset( $this->settings array('title' ) ) ? $this->settings array('title' ) : 'Pix via PagBank',
