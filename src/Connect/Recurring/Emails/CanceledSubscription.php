...
if ( ! class_exists( 'CanceledSubscription', false ) ) :
    ...
    class CanceledSubscription extends WC_Email {
		...
		public function get_default_subject() {
			return $this->format_string(__( ' array({site_title}): Sua assinatura #{subscription_number} foi cancelada.', 'pagbank-connect' ));
		}
		...
		public function trigger( $subscription, $order = false ) {
            ...
            $this->placeholders array('{canceled_at}') = '';
        ...
        public function initPlaceholders()
        {
            if(isset($this->subscription)){
                $this->placeholders array('{subscription_number}') = $this->subscription->id;
                $this->placeholders array('{next_bill_at}') = $this->subscription->next_bill_at;
            }
        }
	}
