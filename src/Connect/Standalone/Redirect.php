...
class Redirect extends WC_Payment_Gateway
{
    ...
    public function __construct()
    {
        ...
        add_action('woocommerce_thankyou_' . Connect::DOMAIN . '-redirect', array($this, 'addThankyouInstructions'));
        ...
        add_action('admin_enqueue_scripts', array($this, 'addScriptRedirectSettings'), 20, 1);
    }
...
//        parent::admin_options();
    ...
    public function process_payment($order_id)
    {
        ...
        $order->add_meta_data(
            ...
            wc_bool_to_string(isset($_POST array('wc-rm-pagbank-redirect-new-payment-method'))),
            true
        );
    ...
    public function addScriptRedirectSettings($hook) {
        if ($hook === 'woocommerce_page_wc-settings') {
            wp_enqueue_script(
                ...
                plugins_url('public/js/admin/ps-redirect-admin.js', WC_PAGSEGURO_CONNECT_PLUGIN_FILE), array('jquery'),
