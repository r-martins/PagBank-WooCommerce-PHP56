...
return array(
	...
	'title'        => array('title'       => __('Title', 'pagbank-connect'),
		'type'        => 'safe_text',
	...
	'boleto_instructions' => array('title'       => __('Instruções', 'pagbank-connect'),
		'type'        => 'textarea',
	...
	'boleto_expiry_days'  => array('title'       => __('Validade do boleto', 'pagbank-connect'),
		'type'        => 'number',
		'description' => __('dias', 'pagbank-connect'),
		'default'     => 7,
		'desc_tip'    => false,
	),
	'boleto_line_1'       => array('title'   => __('Instruções (Linha 1)', 'pagbank-connect'),
		'type'    => 'text',
	...
	'boleto_line_2'       => array('title'   => __('Instruções (Linha 2)', 'pagbank-connect'),
		'type'    => 'text',
	...
	'boleto_discount'     => array('title'       => __('Oferecer Desconto de', 'pagbank-connect'),
		'type'        => 'text',
		'description' => __(
    ...
    'boleto_discount_excludes_shipping' => array('title'       => __('Excluir Frete', 'pagbank-connect'),
    ...
    'boleto_send_new_order_email' => array('title'       => __('Enviar e-mail de novo pedido', 'pagbank-connect'),
