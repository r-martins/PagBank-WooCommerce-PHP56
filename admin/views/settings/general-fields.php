...
return array(
	'connect_key' => array('title'       => esc_html( __( 'Connect Key', 'pagbank-connect' ) ),
        'type'        => 'text',
	...
	'general' => array('title' => esc_html( __( 'Configurações Gerais', 'pagbank-connect' ) ),
        'type'  => 'title',
        'desc'  => '',
        'id'    => 'wc_pagseguro_connect_general_options',
	),
    'hide_if_unavailable' => array('title' => esc_html(__( 'Ocultar meios de pagamento', 'pagbank-connect')),
    ...
    'skip_processing_virtual' => array('title' => esc_html(__( 'Produtos Virtuais', 'pagbank-connect')),
	...
	'title' => array('title'       => esc_html( __( 'Título Principal' , 'pagbank-connect' ) ),
        'type'        => 'text',
    ...
    'shipping_param' => array('title'		=> __('Endereço de Entrega', 'pagbank-connect'),
        'type'		=> 'select',
    ...
    'icons_color' => array('title'		=> __('Cor dos Ícones', 'pagbank-connect'),
        'type'		=> 'text',
    ...
    'success_behavior' => array('title'		=> __('Comportamento ao confirmar pagamento', 'pagbank-connect'),
        'type'		=> 'select',
    ...
    'success_behavior_url' => array('title'       => esc_html( __( 'URL' , 'pagbank-connect' ) ),
        'type'        => 'text',
    ...
    'success_behavior_js' => array('title'       => esc_html(__('JavaScript Personalizado', 'pagbank-connect')),
        'type'        => 'textarea',
    ...
    'force_order_update' => array('title'       => esc_html(__('Forçar atualização de pedidos automaticamente', 'pagbank-connect')),
    ...
    'hide_items' => array('title' => esc_html(__( 'Ocultar itens do pedido', 'pagbank-connect')),
    ...
    'hash_email_active' => array('title' => esc_html(__( 'Ocultar e-mail do comprador', 'pagbank-connect')),
