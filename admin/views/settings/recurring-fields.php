...
return array( array('title' => esc_html( __( 'Configurações de Recorrência', 'pagbank-connect' ) ),
        'type'  => 'title',
    ...
    ), array('type'  => RM_PagBank\Connect\Recurring::removeSandboxSubscriptions() ? 'title' : 'hidden',
        'desc'  => sprintf(
    ...
    ), array('id'          => 'woocommerce_rm-pagbank-recurring_enabled',
        'title'       => __( 'Habilitar Recorrência', 'pagbank-connect'),
        'desc'       => __( 'Habilitar Recorrência', 'pagbank-connect' ),
        'type'        => 'checkbox',
        'description' => '',
        'default'     => 'no'
	), array('id'          => 'woocommerce_rm-pagbank-recurring_payments',
...
//  Coming soon
// array(//		'id'          => 'woocommerce_rm-pagbank-recurring_notice_days',
...
//			'max' => 30,
//		),
//	], array('id'          => 'woocommerce_rm-pagbank-recurring_process_frequency',
    ...
    ], array('id'          => 'woocommerce_rm-pagbank-recurring_customer_can_cancel',
        'title'       => __( 'Permitir que o cliente cancele a assinatura?', 'pagbank-connect'),
        'label'       => __( 'Permitir', 'pagbank-connect' ),
        'type'        => 'checkbox',
        'description' => '',
        'default'     => 'yes'
    ), array('id'          => 'woocommerce_rm-pagbank-recurring_customer_can_pause',
        'title'       => __( 'Permitir que o cliente pause a assinatura?', 'pagbank-connect'),
        'label'       => __( 'Permitir', 'pagbank-connect' ),
        'type'        => 'checkbox',
        'description' => '',
        'default'     => 'yes'
    ), array('id'          => 'woocommerce_rm-pagbank-recurring_clear_cart',
        ...
        'default'     => 'no'
    ), array('id'          => 'woocommerce_rm-pagbank-recurring_retry_charge',
    ...
    ), array('id'          => 'woocommerce_rm-pagbank-recurring_retry_attempts',
